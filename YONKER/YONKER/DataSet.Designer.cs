...
namespace YONKER {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductoRow AddProductoRow(string Nombre, double Precio, int Existencia, CategoriaRow parentCategoriaRowByCategoria_Producto, TipoRow parentTipoRowByTipo_Producto, bool Activo, byte[] Foto) {
...
namespace YONKER.DataSet1TableAdapters {
    ...
    public partial class CategoriaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::YONKER.Properties.Settings.Default.REPUESTOSV4ConnectionString;
        }
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Nombre], [Precio], [Existencia], [CategoriaId], [TipoId], [Activo], [Foto]) VALUES (@Nombre, @Precio, @Existencia, @CategoriaId, @TipoId, @Activo, @Foto);
SELECT Id, Nombre, Precio, Existencia, CategoriaId, TipoId, Activo, Foto FROM Producto WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Nombre] = @Nombre, [Precio] = @Precio, [Existencia] = @Existencia, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId, [Activo] = @Activo, [Foto] = @Foto WHERE (([Id] = @Original_Id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId) AND ([Activo] = @Original_Activo));
SELECT Id, Nombre, Precio, Existencia, CategoriaId, TipoId, Activo, Foto FROM Producto WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Precio, Existencia, CategoriaId, TipoId, Activo, Foto FROM dbo" +
                ".Producto";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nombre, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] Foto) {
            if ((Nombre == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] Foto, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo, int Id) {
            if ((Nombre == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, double Precio, int Existencia, int CategoriaId, int TipoId, bool Activo, byte[] Foto, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, int Original_TipoId, bool Original_Activo) {
            return this.Update(Nombre, Precio, Existencia, CategoriaId, TipoId, Activo, Foto, Original_Id, Original_Precio, Original_Existencia, Original_CategoriaId, Original_TipoId, Original_Activo, Original_Id);
        }
    }
