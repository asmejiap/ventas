...
namespace YONKER
{
    public partial class FormFactura : Form
    {
        ...
        public FormFactura()
        {
            ...
            listaProductoBindingSource.DataSource = _productosBL.ObtenerProductos();
        }
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            if (idTextBox.Text != "")
            {
                var resultado = MessageBox.Show("Desea anular esta factua? ", "Anular", MessageBoxButtons.YesNo);
